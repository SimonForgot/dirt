...
struct Transform
{
    ...
    Vec3f vector(const Vec3f &v) const
    {
        ...
        // or
        //      m[col][row].
        return Vec3f(dot(v, Vec3f(m(0, 0), m(0, 1), m(0, 2))), 
            dot(v, Vec3f(m(1, 0), m(1, 1), m(1, 2))),
            dot(v, Vec3f(m(2, 0), m(2, 1), m(2, 2))));
    }
    ...
    Vec3f normal(const Vec3f &n) const
    {
        ...
        return Vec3f(dot(n, Vec3f(mInv(0, 0), mInv(1, 0), mInv(2, 0))),
            dot(n, Vec3f(mInv(0, 1), mInv(1, 1), mInv(2, 1))),
            dot(n, Vec3f(mInv(0, 2), mInv(1, 2), mInv(2, 2))));
    }
    ...
    Vec3f point(const Vec3f &p) const
    {
        ...
        Vec4f v = { p.x,p.y,p.z,1.f };
        auto mul_r4_v = dot(Vec4f(m(3, 0), m(3, 1), m(3, 2), m(3, 3)), v);
        auto mul_r1_v = dot(Vec4f(m(0, 0), m(0, 1), m(0, 2),m(0, 3)),v);
        auto mul_r2_v = dot(Vec4f(m(1, 0), m(1, 1), m(1, 2), m(1, 3)), v);
        auto mul_r3_v = dot(Vec4f(m(2, 0), m(2, 1), m(2, 2), m(2, 3)), v);
        return Vec3f(mul_r1_v,mul_r2_v,mul_r3_v)/mul_r4_v;
    }
